                        ...
                        <table class="display" id="basic-1">
                            ...
                            @foreach($makes as $make)
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                        <a href="{{route('make.edit',$make->id)}}" ><i class="fa fa-edit me-2 font-success"></i></a>

                                        <a href="{{ route('make.destroy',['make' => $make->id]) }}" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal{{$make->id}}"><i class="fa fa-trash font-danger"></i></a>
                                            
                                        <div class="modal fade" id="exampleModal{{$make->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST" action="{{ route('make.destroy',['make' => $make->id]) }}" id="delete-form{{$make->id}}">
                                                    @csrf
