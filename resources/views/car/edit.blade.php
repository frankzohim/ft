@extends('layouts.app')
@section('title',__('Editer un véhicule'))
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row g-3" method="POST" action="{{route('car.update',$car)}}">
                            @csrf
                            @method('PUT')
                            <div class="col-md-6">
                              ...
                              <select class="form-select" aria-label="Default select example" name="make_id">
                                ...
                                <option value="{{$make->id}}" @if ($make->id==$carMake->id) selected @endif>{{$make->name}}</option>
                                @endforeach
                              </select>
                            </div>
                            ...
                            <div class="col-md-6">
                              ...
                              <input type="text" class="form-control" id="chassis" aria-describedby="NameHelp" value="{{$car->chassis_number}}" name="chassis" required>

                            </div>
                            <div class="col-md-6">
                                <label for="exampleFormControlTextarea1" class="form-label">Nombre de places</label>
                                <input type="number" min="2" class="form-control" value="{{$car->number_of_places}}" aria-describedby="NameHelp" name="seats" required>
                              </div>
                              <div class="col-md-6">
                                <label for="exampleFormControlTextarea1" class="form-label">Nombre de portes</label>
                                <input type="number" min="2" class="form-control" value="{{$car->number_of_doors}}" aria-describedby="NameHelp" name="doors" required>
                              </div>
                            
                            <div class="col-md-6">
                                <label for="exampleFormControlTextarea1" class="form-label">Kilométrage</label>
                                <input type="number" min="0" class="form-control" value="{{$car->mileage}}" aria-describedby="NameHelp" name="mileage" required>
                            </div>

                            <div class="col-md-6">
                              <label for="exampleFormControlTextarea1" class="form-label">Année</label>
                              <input type="number" min="0" class="form-control" value="{{$car->year}}" aria-describedby="NameHelp" name="year" required>
                          </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="inputState" class="form-select" name="energy">
                                    ...
                                    <option value="Super" @if($car->energy=="Super") selected @endif>Super</option>
                                    <option value="Gazoil" @if($car->energy=="Gazoil") selected @endif>Gazoil</option>
                                  </select>
                              </div>
                              <div class="col-md-6">
                                ...
                                <select id="inputState" class="form-select" name="air_conditioner">
                                  <option selected>Choisir...</option>
                                  <option value="1" @if($car->air_conditioner==1) selected @endif>Oui</option>
                                  <option value="0" @if($car->air_conditioner==0) selected @endif>Non</option>
                                </select>
                              </div>
                              ...
                              <div class="col-md-6">
                                ...
                                <input type="text" id="color" class="form-select" value="{{$car->color}}" name="color">
