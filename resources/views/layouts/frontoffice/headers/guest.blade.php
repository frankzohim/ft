                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-contact">
                            <ul>
                                <li><i class="fa fa-home" aria-hidden="true"></i>Bienvenue sur Fast Travel</li>
                                <li><i class="fa fa-phone" aria-hidden="true"></i>Appelez-Nous: +237 694779579</li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div>
                                <nav id="main-nav">
                                    ...
                                    <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                        ...
                                        <li><a href="index.html.htm">Publier un trajet</a></li>
                                        <li><a href="about-page.html.htm">Rechercher<div class="lable-nav">new</div></a></li>
                                        
                                        <li><a href="become-vendor.html.htm">Devenir Chauffeur</a></li>
                                    </ul>
                                </nav>
                            </div>
                            <div>
