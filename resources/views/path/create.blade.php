@extends('layouts.app')
@section('title', __('Ajouter un trajet'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                ...
                                <li class="breadcrumb-item">Trajet</li>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
									...
									@endif
                                    <div class="col-xl-6">
                                        <form class="needs-validation add-product-form" method="POST" action="{{route('path.store')}}" >
                                            @csrf
											<div class="form">

                                                <div class="form-group mb-6 row">
                                                    <label for="exampleFormControlTextarea1" class="form-label">Départ</label>
                                                    <select class="form-select" aria-label="Default select example" name="leaving">
                                                ...
                                                <div class="form-group mb-6 row">
                                                    <label for="exampleFormControlTextarea1" class="form-label">Arrivée</label>
